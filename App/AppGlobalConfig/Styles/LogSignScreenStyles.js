...
class LogSignScreenStyles {
    loadStyles = () => {
      ...
      GLOBAL.companyBannerStyle = StyleSheet.create({
        ...
        sample: {
          alignItems: 'center', width: width / 2, height: height / 3,
        },
        samplebg: {
          width: width / 2, height: height / 3, alignSelf: 'center', marginTop: height / 10,
        },
      });
      ...
      GLOBAL.mainTopTabsStyle = StyleSheet.create({
        topTabButtonOn: {
          height: topTabButtonHeight, width: width / 3, backgroundColor: topTabColorOn,
        },
        topTabButtonOff: {
          height: topTabButtonHeight, width: width / 3, backgroundColor: topTabColorOff,
        },
        view: {
          flexDirection: 'row',
        },
